...
class Fighter extends Sprite{
    ...
    switchSprite(sprite) {
        ...
        //Trigger end game logic. All animations end
        if(this.image === this.sprites.death.image){
            if(this.framesCurrent === this.sprites.death.framesMax - 1)
                this.dead = true
            return
        }
        //Override other animations when fighter attacks
        ...
        //Override other animations when fighter gets hit
        if(this.image === this.sprites.takeHit.image &&
            this.framesCurrent < this.sprites.takeHit.framesMax - 1
        )
        return

        //Override other animations when fighter dies
        switch(sprite) {
